...
/// Clase encargad de preparar la navegación y estructura básica del wiget [NuevoUsuario]
///
/// Más opciones en [PantallaCambiarNombre]
class PantallaNuevoUsuario extends PantallasMenu {
  ...
  static void preparaNavegacion(String id,
    ...
    //
    ruta = Ruta(id, nombreRuta, (token) => NuevoUsuario(token: token));
    ...
    cfgPantalla = PantallasConfig(
        ...
        // correspondiente
        itemMenu: ItemMenu(Icons.account_circle_rounded, ruta.hacia,
  ...
  PantallaNuevoUsuario(BuildContext context, {Key? key})
      : super(Text(AppLocalizations.of(context)!.nuevoUsuario), ruta.id,
            key: key,
