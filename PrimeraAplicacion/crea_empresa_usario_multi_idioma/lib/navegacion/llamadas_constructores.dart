...
/*aLogin(BuildContext context, {Object? arguments}) {
  ...
  return vesA(Ruta.getRuta('IniciaLogin'), context, arguments: arguments);
}
...
Future<T?> aEmpresaNueva<T extends Object?>(BuildContext context,
    {Object? arguments}) {
  return vesA(Ruta.getRuta('EmpresaNueva'), context, arguments: arguments);
}*/
...
Future<T?> aUsuarioNuevo<T extends Object?>(BuildContext context,
    {Object? arguments}) {
  return vesA(Ruta.getRuta('UsuarioNuevo'), context, arguments: arguments);
}
